...
* **No silent undercount.** Requests without a task id make the count a lower bound: the preview shows it with an `uncounted_usage` blocker, and closing the period returns `409 uncounted_usage`.
