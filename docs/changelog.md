...
* **Vendor Marketplace tidied.** The standalone **Venice AI** and **Sarvam AI** nav entries were removed; both are now documented as providers under [Floe Inference](developers/keyless-inference.md), with the live model list at `GET /v1/models` (keyless).
