...
See [`floe-examples/langchain-agent`](https://github.com/Floe-Labs/floe-examples/tree/main/langchain-agent) for a complete LangChain agent that funds a balance, pays an x402 endpoint through the proxy, and checks its remaining spend.
