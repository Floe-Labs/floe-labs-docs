...
See [`floe-examples/langchain-agent`](https://github.com/Floe-Labs/floe-examples/tree/main/langchain-agent) for a complete LangChain agent that borrows, pays an x402 endpoint, and repays.
