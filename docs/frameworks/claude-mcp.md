...
All 65 Floe MCP tools — agent lifecycle, key minting, spend controls, cost preflight, **x402 payment execution**, funding instructions, usage analytics, webhooks, docs search, and the on-chain protocol tools. See the [MCP Server reference](../developers/mcp-server.md).
