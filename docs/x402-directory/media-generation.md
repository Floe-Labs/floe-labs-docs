...
|-----|----------|-------|--------|--------|
| AI Image Generation | CoinOpAI | $0.25 | GET | unverified |
...
**Provider:** [CoinOpAI](https://imagegen.coinopai.com)
**Endpoint:** `GET https://imagegen.coinopai.com/generate`
**Price:** $0.25 USDC per call · Base mainnet
**Floe compatible:** Yes

> Generate an AI image from a text prompt (text-to-image)
...
curl -X POST https://credit-api.floelabs.xyz/v1/proxy/fetch \
  ...
  -d '{"url": "https://imagegen.coinopai.com/generate", "method": "GET"}'
```
