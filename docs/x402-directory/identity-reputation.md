...
|-----|----------|-------|--------|--------|
| AI Notarization & Proof | ForgeMesh Labs | $0.001 | POST | unverified |
...
curl -X POST https://credit-api.floelabs.xyz/v1/proxy/fetch \
  ...
  -d '{"url": "https://notary.forgemesh.io/api/notarize", "method": "POST"}'
```
