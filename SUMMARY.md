...
* [x402 API Directory](docs/x402-directory/README.md)
  ...
  * [Storage](docs/x402-directory/storage.md)
  * [Identity & Reputation](docs/x402-directory/identity-reputation.md)
  * [Payments & Commerce](docs/x402-directory/payments-commerce.md)
  * [Infrastructure & Gateways](docs/x402-directory/infra-gateway.md)
  * [Agent Tooling](docs/x402-directory/agent-tooling.md)
